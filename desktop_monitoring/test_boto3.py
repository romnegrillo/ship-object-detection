...
s3.upload_file("./test_upload_image/test_upload.png",
               BUCKET_NAME, "detected_ships/10-30-2022-10-30-AM-5.png")
time.sleep(1)

s3.upload_file("./test_upload_image/test_upload.png",
               BUCKET_NAME, "detected_ships/10-30-2022-10-35-AM-5.png")
time.sleep(1)

s3.upload_file("./test_upload_image/test_upload.png",
               BUCKET_NAME, "detected_ships/10-30-2022-10-40-AM-5.png")
time.sleep(1)

s3.upload_file("./test_upload_image/test_upload.png",
               BUCKET_NAME, "detected_ships/10-30-2022-10-45-AM-5.png")
time.sleep(1)


s3.download_file(BUCKET_NAME, "detected_ships/10-30-2022-10-45-AM-5.png",
                 "./test_download_image/10-30-2022-10-45-AM-2.png")

print(os.path.exists("test_download_image/10-30-2022-10-45-AM-5.png"))
